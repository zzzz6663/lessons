<div id="header" class="rows">
        ...
        <ul>
            ...
            <li class="parent"><a href="#">
                ...
                <ul>
                    ...
                    <li class="{{ ucwords(app()->getLocale())==ucwords($lang->name)?"active_l":""}}"><a href="{{ route("locale",$lang->id) }}">
    ...
    <div id="topleft">
        {{--  <div id="mabenav"><span><i class="icon-menu"></i></span></div>  --}}
        {{-- <div id="langs">
            <span>
                LanGuages
            </span>
...
<div id="sens" hidden data-reserve="{{ $user->short(152) }}" data-time="{{ $user->short(252) }}" data-date="{{ $user->short(251) }}" data-mes1="{{ $user->short(266) }}" data-mes2="{{ $user->short(267) }}" data-mes3="{{ $user->short(345) }}"></div>
